...
shared_ptr<adaptation::RateConstants> g_adaptation;
...
fmi2Status getX(const fmi2ValueReference vr[], size_t nvr, T value[],
		T (adaptation::RateConstants::*getter)(fmi2ValueReference vr))
{
	try
	{
...
{
	return getX(vr, nvr, value, &adaptation::RateConstants::getFmiValueReal);
}

extern "C" fmi2Status fmi2GetInteger(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Integer value[])
{
	return getX(vr, nvr, value, &adaptation::RateConstants::getFmiValueInteger);
}

extern "C" fmi2Status fmi2GetBoolean(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Boolean value[])
{
	typedef bool (adaptation::RateConstants::*GB)(fmi2ValueReference);
	typedef int (adaptation::RateConstants::*GI)(fmi2ValueReference);

	GB g = &adaptation::RateConstants::getFmiValueBoolean;
