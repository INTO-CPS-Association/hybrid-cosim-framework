...
shared_ptr<adaptation::PlantMultiRate> g_adaptation;
		...
		fmi2Boolean loggingOn)
{
	...
	g_adaptation = make_shared<adaptation::PlantMultiRate>(name, resourceLoc, functions);
	try
	{
...
fmi2Status getX(const fmi2ValueReference vr[], size_t nvr, T value[],
		T (adaptation::PlantMultiRate::*getter)(fmi2ValueReference vr))
{
	try
	{
...
{
	return getX(vr, nvr, value, &adaptation::PlantMultiRate::getFmiValueReal);
}

extern "C" fmi2Status fmi2GetInteger(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Integer value[])
{
	return getX(vr, nvr, value, &adaptation::PlantMultiRate::getFmiValueInteger);
}

extern "C" fmi2Status fmi2GetBoolean(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Boolean value[])
{
	typedef bool (adaptation::PlantMultiRate::*GB)(fmi2ValueReference);
	typedef int (adaptation::PlantMultiRate::*GI)(fmi2ValueReference);

	GB g = &adaptation::PlantMultiRate::getFmiValueBoolean;
