...
shared_ptr<adaptation::SensorMultiRate> g_adaptation;
		...
		fmi2Boolean loggingOn)
{
	...
	g_adaptation = make_shared<adaptation::SensorMultiRate>(name, resourceLoc, functions);
	try
	{
...
fmi2Status getX(const fmi2ValueReference vr[], size_t nvr, T value[],
		T (adaptation::SensorMultiRate::*getter)(fmi2ValueReference vr))
{
	try
	{
...
{
	return getX(vr, nvr, value, &adaptation::SensorMultiRate::getFmiValueReal);
}

extern "C" fmi2Status fmi2GetInteger(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Integer value[])
{
	return getX(vr, nvr, value, &adaptation::SensorMultiRate::getFmiValueInteger);
}

extern "C" fmi2Status fmi2GetBoolean(fmi2Component c, const fmi2ValueReference vr[], size_t nvr, fmi2Boolean value[])
{
	typedef bool (adaptation::SensorMultiRate::*GB)(fmi2ValueReference);
	typedef int (adaptation::SensorMultiRate::*GI)(fmi2ValueReference);

	GB g = &adaptation::SensorMultiRate::getFmiValueBoolean;
